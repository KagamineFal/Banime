                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<input type='checkbox' name='kategori[]' value='" . $row['id'] . "'> " . $row['kategori'] . "<br>";
                                        }
...
if (isset($_POST["sv"])) {
    ...
    $sql = "INSERT INTO konten_anime (judul, deskripsi, deskripsi_dalem, tgl, gambar, id_kategori) 
            VALUES ('$jdl', '$des', '$isi', '$convertedDate', '$nama_file_baru', '$categoryString')";
